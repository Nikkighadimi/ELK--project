...
- _Which file do you update to make Ansible run the playbook on a specific machine? ansible.cfg      How do I specify which machine to install the ELK server on versus which to install Filebeat on? 
